...
public abstract class Executable {
   public Object exec() throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.NONE, Environment.NONE);
   }

   public Object exec(final InputStream input) throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.NONE, Environment.NONE);
   }

   public Object exec(final InputStream input, final Map<String, ? extends Object> scope) throws AbortedException,
         ResolveException, ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.NONE, new Environment(scope));
   }

   public Object exec(final InputStream input, final PrintStream output) throws AbortedException, ResolveException,
         ExecutionException {
   ...
   public Object exec(final InputStream input, final PrintStream output, final Map<String, ? extends Object> scope)
         throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.stream(output), new Environment(scope));
   }

   public Object exec(final InputStream input, final Writer output) throws AbortedException, ResolveException,
         ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.stream(output), Environment.NONE);
   }
   ...
   public Object exec(final Map<String, ? extends Object> scope) throws AbortedException, ResolveException,
         ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.NONE, new Environment(scope));
   }

   public Object exec(final PrintStream output) throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.stream(output), Environment.NONE);
   }

   public Object exec(final PrintStream output, final Map<String, ? extends Object> scope) throws AbortedException,
         ResolveException, ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.stream(output), new Environment(scope));
   }

   public Object exec(final Reader input) throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.NONE, Environment.NONE);
   }

   public Object exec(final Reader input, final Map<String, ? extends Object> scope) throws AbortedException,
         ResolveException, ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.NONE, new Environment(scope));
   }

   public Object exec(final Reader input, final PrintStream output) throws AbortedException, ResolveException,
         ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.stream(output), Environment.NONE);
   }
   ...
   public Object exec(final Reader input, final Writer output) throws AbortedException, ResolveException,
         ExecutionException {
      return exec(CodePointInStream.stream(input), ObjectOutStream.stream(output), Environment.NONE);
   }
   ...
   public Object exec(final Writer output) throws AbortedException, ResolveException, ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.stream(output), Environment.NONE);
   }

   public Object exec(final Writer output, final Map<String, ? extends Object> scope) throws AbortedException,
         ResolveException, ExecutionException {
      return exec(CodePointInStream.NONE, ObjectOutStream.stream(output), new Environment(scope));
   }
