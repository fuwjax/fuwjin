...
public class ChessurInterpreter {
   ...
   private static Object AbortStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      Sep(sub194, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.AbortStatement(
   ...
   private static Object AcceptStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.FilterAcceptStatement((java.lang.Boolean)sub124.isSet(
               "notted", env[11]), (org.fuwjin.chessur.expression.Filter)InFilter(sub124, env));
      } catch(final ChessurException e128) {
         try {
            env[7] /* stmt */= new org.fuwjin.chessur.expression.ValueAcceptStatement((java.lang.Boolean)sub124.isSet(
                  "notted", env[11]), (org.fuwjin.chessur.expression.Expression)Value(sub124, env));
   ...
   private static Object AliasDeclaration(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         ...
         try {
            try {
               ((org.fuwjin.chessur.expression.Catalog)sub10.isSet("cat", env[1])).alias(
         ...
         try {
            ...
            try {
               try {
                  ((org.fuwjin.chessur.expression.Catalog)sub14.isSet("cat", env[1])).aliasSignature(
   ...
   private static Object AliasName(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      env[22] /* alias */= ((org.fuwjin.chessur.expression.Catalog)sub212.isSet("cat", env[1])).alias((java.lang.String)sub212
            .isSet("prefix", env[21]));
      try {
   ...
   private static Object Assignment(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      S(sub202, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.Assignment(
   ...
   private static Object Block(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      sub196.accept("{");
      S(sub196, env);
      env[19] /* block */= new org.fuwjin.chessur.expression.Block();
      try {
         try {
            ((org.fuwjin.chessur.expression.Block)sub196.isSet("block", env[19]))
   ...
   private static Object Catalog(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      env[1] /* cat */= new org.fuwjin.chessur.expression.Catalog(null, null);
      S(sub43, env);
      try {
         try {
            ...
            try {
               ...
               try {
                  ((org.fuwjin.chessur.expression.Catalog)sub43.isSet("cat", env[1]))
   ...
   private static Object CouldStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      Sep(sub188, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.CouldStatement(
   ...
   private static Object DynamicLiteral(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      sub95.accept("\"");
      env[9] /* lit */= new org.fuwjin.chessur.expression.CompositeLiteral();
      try {
         try {
            ...
            S(sub96, env);
            try {
               ((org.fuwjin.chessur.expression.CompositeLiteral)sub96.isSet("lit", env[9]))
            ...
            try {
               ...
               try {
                  ((org.fuwjin.chessur.expression.CompositeLiteral)sub99.isSet("lit", env[9]))
               ...
               try {
                  ((org.fuwjin.chessur.expression.CompositeLiteral)sub102.isSet("lit", env[9]))
         ...
         try {
            while(true) {
               try {
                  ...
                  S(sub104, env);
                  try {
                     ((org.fuwjin.chessur.expression.CompositeLiteral)sub104.isSet("lit", env[9]))
                  ...
                  try {
                     ...
                     try {
                        ((org.fuwjin.chessur.expression.CompositeLiteral)sub107.isSet("lit", env[9]))
                     ...
                     try {
                        ((org.fuwjin.chessur.expression.CompositeLiteral)sub110.isSet("lit", env[9]))
   ...
   private static Object EitherOrStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      Sep(sub178, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.EitherOrStatement(
      ...
      try {
         ...
         try {
            try {
               ((org.fuwjin.chessur.expression.EitherOrStatement)sub180.isSet("stmt", env[7]))
         ...
         try {
            while(true) {
               ...
               try {
                  try {
                     ((org.fuwjin.chessur.expression.EitherOrStatement)sub183.isSet("stmt", env[7]))
   ...
   private static Object Escape(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         ...
         sub234.accept("n");
         env[10] /* ch */= org.fuwjin.chessur.expression.Literal.NEW_LINE;
         sub234.commit();
      } catch(final ChessurException e235) {
         try {
            final StringCursor sub236 = sub233.sub();
            sub236.accept("t");
            env[10] /* ch */= org.fuwjin.chessur.expression.Literal.TAB;
            sub236.commit();
         } catch(final ChessurException e237) {
            try {
               final StringCursor sub238 = sub233.sub();
               sub238.accept("r");
               env[10] /* ch */= org.fuwjin.chessur.expression.Literal.RETURN;
               sub238.commit();
            } catch(final ChessurException e239) {
               try {
                  final StringCursor sub240 = sub233.sub();
                  sub240.accept("x");
                  env[10] /* ch */= org.fuwjin.chessur.expression.Literal.parseHex((java.lang.String)HexDigits(sub240,
                        env));
                  sub240.commit();
   ...
   private static Object Field(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      S(sub222, env);
      try {
         ((org.fuwjin.chessur.expression.ObjectTemplate)sub222.isSet("object", env[18])).set(
   ...
   private static Object FilterRange(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         ...
         S(sub225, env);
         try {
            ((org.fuwjin.chessur.expression.Filter)sub225.isSet("filter", env[20])).addRange(
         ...
         try {
            ((org.fuwjin.chessur.expression.Filter)sub228.isSet("filter", env[20])).addChar((java.lang.Integer)sub228
                  .isSet("start", env[25]));
   ...
   private static Object Invocation(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      env[3] /* signature */= ((org.fuwjin.chessur.expression.Catalog)sub130.isSet("cat", env[1]))
            .getSignature((java.lang.String)sub130.isSet("name", env[4]));
      sub130.accept("(");
      S(sub130, env);
      env[12] /* inv */= new org.fuwjin.chessur.expression.Invocation();
      try {
         final StringCursor sub131 = sub130.sub();
         try {
            ((org.fuwjin.chessur.expression.Invocation)sub131.isSet("inv", env[12]))
         ...
         try {
            ...
            try {
               try {
                  ((org.fuwjin.chessur.expression.Invocation)sub133.isSet("inv", env[12]))
            ...
            try {
               while(true) {
                  ...
                  try {
                     try {
                        ((org.fuwjin.chessur.expression.Invocation)sub136.isSet("inv", env[12]))
      ...
      try {
         ...
         try {
            ((org.fuwjin.chessur.expression.Invocation)sub143.isSet("inv", env[12]))
                  .setFunction((org.fuwjin.dinah.Function)sub143.isSet("function", env[13]));
   ...
   private static Object IsStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.IsStatement((java.lang.Boolean)sub171.isSet("notted",
               env[11]),
         ...
         try {
            ...
            try {
               env[7] /* stmt */= new org.fuwjin.chessur.expression.IsStatement((java.lang.Boolean)sub171.isSet(
                     "notted", env[11]), (org.fuwjin.chessur.expression.Expression)Value(sub171, env));
   ...
   private static Object LoadDeclaration(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         try {
            ((org.fuwjin.chessur.expression.Catalog)sub3.isSet("cat", env[1])).load((java.lang.String)sub3.isSet("path", env[0]),
   ...
   private static Object Number(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      env[15] /* num */= new org.fuwjin.chessur.expression.Number((java.lang.String)sub147.match());
      Sep(sub147, env);
      sub147.commit();
   ...
   private static Object Object(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      env[18] /* object */= new org.fuwjin.chessur.expression.ObjectTemplate((org.fuwjin.dinah.Function)sub162.isSet(
            "constructor", env[17]));
      sub162.accept(")");
      S(sub162, env);
      sub162.accept("{");
   ...
   private static Object PublishStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      Sep(sub192, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.PublishStatement(
   ...
   private static Object RepeatStatement(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      Sep(sub190, env);
      try {
         env[7] /* stmt */= new org.fuwjin.chessur.expression.RepeatStatement(
   ...
   private static Object ScriptIdent(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      try {
         ...
         env[23] /* module */= ((org.fuwjin.chessur.expression.Catalog)sub218.isSet("cat", env[1]))
               .getModule((java.lang.String)sub218.isSet("id", env[6]));
         env[5] /* script */= ((org.fuwjin.chessur.expression.Catalog)sub218.isSet("module", env[23]))
               .get((java.lang.String)sub218.isSet("name", env[4]));
         sub218.commit();
      } catch(final ChessurException e219) {
         final StringCursor sub220 = sub216.sub();
         env[5] /* script */= ((org.fuwjin.chessur.expression.Catalog)sub220.isSet("cat", env[1])).get((java.lang.String)sub220
               .isSet("id", env[6]));
         sub220.commit();
      }
      try {
   ...
   private static Object StaticLiteral(final StringCursor input, final Object... parentEnv) throws ChessurException {
      ...
      sub81.accept("'");
      env[9] /* lit */= new org.fuwjin.chessur.expression.Literal();
      try {
         try {
            final StringCursor sub82 = sub81.sub();
            env[10] /* ch */= sub82.acceptNotIn("'\\", "'\\");
            try {
               ((org.fuwjin.chessur.expression.Literal)sub82.isSet("lit", env[9])).append((java.lang.Integer)sub82
                     .isSet("ch", env[10]));
            ...
            try {
               ((org.fuwjin.chessur.expression.Literal)sub85.isSet("lit", env[9])).append((java.lang.Integer)Escape(
                     sub85, env));
         ...
         try {
            while(true) {
               try {
                  ...
                  try {
                     ((org.fuwjin.chessur.expression.Literal)sub87.isSet("lit", env[9]))
                           .append((java.lang.Integer)sub87.isSet("ch", env[10]));
                  ...
                  try {
                     ((org.fuwjin.chessur.expression.Literal)sub90.isSet("lit", env[9]))
                        ...
                        try {
                           ...
                           try {
                              ...
                              try {
                                 ...
                                 env[8] /* val */= new org.fuwjin.chessur.expression.Variable((java.lang.String)Name(
                                       sub71, env));
                              }
                           }
                        }
