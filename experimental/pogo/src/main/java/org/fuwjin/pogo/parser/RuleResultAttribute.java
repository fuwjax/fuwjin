...
public class RuleResultAttribute implements ParsingExpression, Attribute {
   private final String name;
   private Function function;
   private ParsingExpression parser;

   public RuleResultAttribute(final String name) {
      this.name = name;
   }
   ...
   public boolean equals(final Object obj) {
      try {
         final RuleResultAttribute o = (RuleResultAttribute)obj;
