...
public class DefaultAnnotationTest{
   ...
   public void testUnequalType(){
      @NullAnnotation(type=Object.class) class DifferentAnnotation{}
   ...
   public void testUnequalValues(){
      @TestAnnotation(val=1,types={}) class NonDefaultAnnotation{}
   ...
   private String[] sort(String[] split){
      Arrays.sort(split);
      return split;
   }

   private String[] split(String strip){
      return strip.split(", ");
   }
