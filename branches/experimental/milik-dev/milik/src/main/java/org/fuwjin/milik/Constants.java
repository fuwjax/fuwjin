...
public interface Constants extends Opcodes {
  ...
  String MILIK_VERSION = "1.0.0-SNAPSHOT";
  ...
  String D_FIBER = "Lorg/fuwjin/milik/Fiber;";
  String D_STATE = "Lorg/fuwjin/milik/State;";
  String D_TASK = "Lorg/fuwjin/milik/Task;";
  String D_PAUSABLE = "Lorg/fuwjin/milik/Pausable;";

  String THROWABLE_CLASS = "java/lang/Throwable";
  String FIBER_CLASS = "org/fuwjin/milik/Fiber";
  String STATE_CLASS = "org/fuwjin/milik/State";
  String TASK_CLASS = "org/fuwjin/milik/Task";
  String PAUSABLE_CLASS = "org/fuwjin/milik/Pausable";
  String NOT_PAUSABLE_CLASS = "org/fuwjin/milik/NotPausable";
