...
import static org.fuwjin.milik.Constants.LDC2_W;
 ...
 * 
 * Usage: java org.fuwjin.milik.tools.Asm <.j file(s)>
 * 
...
public class Asm {
  ...
  public Asm(String afileName) throws IOException {
    ...
    try {
      ...
      if (!eofOK) {
        throw new RuntimeException("Premature end of file: " + fileName);
      }
  ...
  // The field declaration "public final String fileName = "foobar" is declared
  // as
  ...
  private static Pattern fieldPattern = Pattern.compile(".field +(" + modifierPatternStr + ")* +(" + namePatternStr
      + ") +(" + descPatternStr + ") *(= *(.*))?");
  ...
  private void parseField() {
    ...
    Object value = valueStr == null ? null : parseValue(valueStr, (desc.equals(D_DOUBLE) || desc.equals(D_LONG)));
  ...
  private static Pattern methodPattern = Pattern.compile(".method +(" + modifierPatternStr + ")* ("
      + methodNamePatternStr + ") *([(][^\\s]+)");
  ...
  static Pattern catchPattern = Pattern.compile(".catch +(" + classNamePatternStr
      + ") +from +([\\w]+) +to +([\\w]+) +using +([\\w]+)");
  ...
  static String opcodeStrs[] = { "nop", "aconst_null", "iconst_m1", "iconst_0", "iconst_1", "iconst_2", "iconst_3",
      "iconst_4", "iconst_5", "lconst_0", "lconst_1", "fconst_0", "fconst_1", "fconst_2", "dconst_0", "dconst_1",
      ...
      "pop", "pop2", "dup", "dup_x1", "dup_x2", "dup2", "dup2_x1", "dup2_x2", "swap", "iadd", "ladd", "fadd", "dadd",
      "isub", "lsub", "fsub", "dsub", "imul", "lmul", "fmul", "dmul", "idiv", "ldiv", "fdiv", "ddiv", "irem", "lrem",
      "frem", "drem", "ineg", "lneg", "fneg", "dneg", "ishl", "lshl", "ishr", "lshr", "iushr", "lushr", "iand", "land",
      "ior", "lor", "ixor", "lxor", "iinc", "i2l", "i2f", "i2d", "l2i", "l2f", "l2d", "f2i", "f2l", "f2d", "d2i",
      "d2l", "d2f", "i2b", "i2c", "i2s", "lcmp", "fcmpl", "fcmpg", "dcmpl", "dcmpg", "ifeq", "ifne", "iflt", "ifge",
      ...
      "invokestatic", "invokeinterface", "unused", "new", "newarray", "anewarray", "arraylength", "athrow",
  ...
  static {
    ...
    visitTypes = new byte[] { INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INT, INT, LDC, LDC, LDC, VAR, VAR, VAR, VAR, VAR, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, VAR, VAR, VAR, VAR, VAR, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, IINC, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
        INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP,
        JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, VAR, TABLESWITCH, LOOKUPSWITCH, INSN, INSN, INSN, INSN, INSN, INSN,
        FIELD, FIELD, FIELD, FIELD, METHOD, METHOD, METHOD, METHOD, INSN, TYPE, INT, TYPE, INSN, INSN, TYPE, TYPE,
        INSN, INSN, INSN, MULTIANEWARRAY, JUMP, JUMP, JUMP, JUMP };
  }
