...
/**
 * This class is called by Detector to parse signatures of classes that may have
 * verification errors. It uses asm to open the file instead of trying to
 * classload it.
 */
public class AsmDetector {
  ...
  private static ClassCache cache(String className, ClassNode cn) {
    ...
    LOOP: for (Object m : cn.methods) {
      MethodNode mn = (MethodNode) m;
      for (Object exception : mn.exceptions) {
        if ("org/fuwjin/milik/Pausable".equals(exception)) {
  ...
  public static void main(String[] args) {
    AsmDetector
        .getPausableStatus(
            ...
            "putInternal",
            "Lcom/sleepycat/je/Transaction;Lcom/sleepycat/je/DatabaseEntry;Lcom/sleepycat/je/DatabaseEntry;Lcom/sleepycat/je/dbi/PutMode;Lorg/fuwjin/milik/Fiber;)Lcom/sleepycat/je/OperationStatus;)V",
            Detector.DEFAULT);
  }
