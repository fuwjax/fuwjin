...
import org.fuwjin.milik.nio.EndPoint;
import org.fuwjin.milik.nio.ExposedBaos;
...
public class HttpResponse extends HttpMsg {
  ...
  public static final byte[] F_SERVER = ("Server: milik " + Constants.MILIK_VERSION + "\r\n").getBytes();
  ...
  /**
   * The status line for the response. Can use any of the predefined strings in
   * HttpResponse.ST_*.
   */
  public byte[] status;
