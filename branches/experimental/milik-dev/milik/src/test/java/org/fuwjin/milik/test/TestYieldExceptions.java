...
public class TestYieldExceptions extends TestCase {
    ...
    public void testOrdinaryCatch()  throws Exception {
        TestYield.runTask(new org.fuwjin.milik.test.ex.ExCatch(0));
    }
    ...
    public void testPausableCatch() throws Exception {
        TestYield.runTask(new org.fuwjin.milik.test.ex.ExCatch(1));
    }
    ...
    public void testNestedException() throws Exception {
        TestYield.runTask(new org.fuwjin.milik.test.ex.ExCatch(2));
    }
    ...
    public void testTryCatchFinally() throws Exception {
        TestYield.runTask(new org.fuwjin.milik.test.ex.ExCatch(3));
    }
}
