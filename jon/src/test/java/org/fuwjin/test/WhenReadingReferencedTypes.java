...
public class WhenReadingReferencedTypes {
   ...
   public void shouldReadDefaultComplexChild() throws ParseException {
      final ComplexChild result =
            (ComplexChild)new JonReader(
   ...
   public void shouldReadDefaultIntegerObject() throws ParseException {
      final IntegerObject result =
            (IntegerObject)new JonReader("&0=(&1=org.fuwjin.test.object.IntegerObject){i:15}").read();
   ...
   public void shouldReadDefaultSelfRefObject() throws ParseException {
      final SelfReferencingObject result =
            (SelfReferencingObject)new JonReader("&0=(&1=org.fuwjin.test.object.SelfReferencingObject){obj:&0}").read();
      assertThat(result, sameInstance(result.getSelf()));
   }

   @Test
   public void shouldReadDefaultSimpleChild() throws ParseException {
      final SimpleChild result =
            (SimpleChild)new JonReader(
   ...
   public void shouldReadDefaultSimpleGrandChild() throws ParseException {
      final SimpleGrandChild result =
            (SimpleGrandChild)new JonReader(
   ...
   public void shouldReadDefaultSimpleGreatGrandChild() throws ParseException {
      final SimpleGreatGrandChild result =
            (SimpleGreatGrandChild)new JonReader(
   ...
   public void shouldReadDefaultSimpleObject() throws ParseException {
      final SimpleObject result =
            (SimpleObject)new JonReader("&0=(&1=org.fuwjin.test.object.SimpleObject){s:\"howdy\",io:&2={i:17}}").read();
      assertThat(result, is(new SimpleObject()));
   }

   @Test
   public void shouldReadDefaultTransientChild() throws ParseException {
      final TransientChild result =
            (TransientChild)new JonReader("&0=(&1=org.fuwjin.test.object.TransientChild){i:191}").read();
   ...
   public void shouldReadList() throws ParseException {
      final LinkedList<String> result =
            (LinkedList<String>)new JonReader("&0=(&1=java.util.LinkedList)[\"hi\",\"hello\"]").read();
   ...
   public void shouldReadMap() throws ParseException {
      final TreeMap<String, String> result =
            (TreeMap<String, String>)new JonReader("&0=(&1=java.util.TreeMap){\"hi\":\"mom\",\"hello\":\"world\"}")
                  .read();
   ...
   public void shouldReadNullStringField() throws ParseException {
      final SimpleObject result =
            (SimpleObject)new JonReader("&0=(&1=org.fuwjin.test.object.SimpleObject){s:null,io:null}").read();
      assertThat(result, is(new SimpleObject(null, null)));
   }

   @Test
   public void shouldReadNullWrapperField() throws ParseException {
      final IntegerField result =
            (IntegerField)new JonReader("&0=(&1=org.fuwjin.test.object.IntegerField){i:null}").read();
      assertThat(result, is(new IntegerField(null)));
   }

   @Test
   public void shouldReadObject() throws ParseException {
      final PrimitiveContainer result =
            (PrimitiveContainer)new JonReader("&1=(&2=org.fuwjin.test.object.PrimitiveContainer){index:17}").read();
   ...
   public void shouldReadSelfRefMap() throws ParseException {
      final Map<Object, Object> result =
            (Map<Object, Object>)new JonReader("&0=(&1=java.util.IdentityHashMap){&0:&0}").read();
   ...
   public void shouldReadSelfRefMapKey() throws ParseException {
      final Map<Object, String> result =
            (Map<Object, String>)new JonReader("&0=(&1=java.util.IdentityHashMap){&0:\"test\"}").read();
   ...
   public void shouldReadSelfRefMapValue() throws ParseException {
      final Map<String, Object> result =
            (Map<String, Object>)new JonReader("&0=(&1=java.util.HashMap){\"test\":&0}").read();
   ...
   public void shouldReadSingleList() throws ParseException {
      final List<String> result =
            (List<String>)new JonReader("&0=(&1=java.util.Collections$SingletonList){element:\"a\"}").read();
   ...
   public void shouldReadSingleMap() throws ParseException {
      final Map<String, String> result =
            (Map<String, String>)new JonReader("&0=(&1=java.util.Collections$SingletonMap){k:\"a\",v:\"b\"}").read();
