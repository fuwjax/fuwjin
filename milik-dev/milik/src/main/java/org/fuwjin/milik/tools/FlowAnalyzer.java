...
import static org.fuwjin.milik.analysis.Utils.dedent;
import static org.fuwjin.milik.analysis.Utils.indent;
import static org.fuwjin.milik.analysis.Utils.pn;
import static org.fuwjin.milik.analysis.Utils.resetIndentation;
...
import org.fuwjin.milik.analysis.ClassFlow;
...
public class FlowAnalyzer {
  public static void main(String[] args) throws Exception {
    if (args.length == 0) {
      throw new RuntimeException("Usage <class name | jar file name> [methodName]");
    }
    String name = args[0];
