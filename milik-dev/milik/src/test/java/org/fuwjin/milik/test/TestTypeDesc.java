...
import static org.fuwjin.milik.Constants.D_ARRAY_BOOLEAN;
import static org.fuwjin.milik.Constants.D_ARRAY_DOUBLE;
import static org.fuwjin.milik.Constants.D_ARRAY_INT;
...
public class TestTypeDesc extends TestCase {
  public void testInterning() throws Exception {
    ...
    // are indeed interned.
    Class<?> c = Class.forName("org.fuwjin.milik.Constants");
  ...
  public void testCommonSuperTypes() {
    ...
    assertSame(TypeDesc.commonSuperType("Ljava/io/Serializable;", "Ljava/lang/Comparable;"), D_OBJECT);
    assertEquals(TypeDesc.commonSuperType("Lorg/fuwjin/milik/BasicBlock;", "Lorg/fuwjin/milik/BasicBlock;"),
        "Lorg/fuwjin/milik/BasicBlock;");
    assertSame(TypeDesc.commonSuperType("[Z", "[Z"), D_ARRAY_BOOLEAN);

    // least upper bound of Field and Method is AccessibleObject
    assertEquals("Ljava/lang/reflect/AccessibleObject;", TypeDesc.commonSuperType("Ljava/lang/reflect/Field;",
    ...
    assertEquals("Lorg/fuwjin/milik/test/ex/ExA;", TypeDesc.commonSuperType("Lorg/fuwjin/milik/test/ex/ExA;",
        "Lorg/fuwjin/milik/test/ex/ExD;"));

    assertEquals("Lorg/fuwjin/milik/test/ex/ExA;", TypeDesc.commonSuperType("Lorg/fuwjin/milik/test/ex/ExD;",
        "Lorg/fuwjin/milik/test/ex/ExA;"));

    assertEquals("Lorg/fuwjin/milik/test/ex/ExA;", TypeDesc.commonSuperType("Lorg/fuwjin/milik/test/ex/ExC;",
        "Lorg/fuwjin/milik/test/ex/ExD;"));

  }

  public void testArray() throws IncompatibleTypesException {
    assertSame(D_OBJECT, TypeDesc.mergeType("Lorg/fuwjin/milik/test/ex/ExC;", "[Z"));

    assertSame(D_OBJECT, TypeDesc.mergeType("[Z", "Lorg/fuwjin/milik/test/ex/ExC;"));
  }
  ...
  public void testArgTypes() throws IncompatibleTypesException {
    ...
    String[] expected = new String[] { "[Ljava/lang/String;", "[[[Z", D_BOOLEAN, D_BYTE, D_CHAR, D_DOUBLE, D_SHORT,
        D_INT, D_LONG, D_FLOAT };
  ...
  public void testMerge() throws IncompatibleTypesException {
    ...
    assertEquals("[Ljava/lang/reflect/AccessibleObject;", TypeDesc.mergeType("[Ljava/lang/reflect/Field;",
        "[Ljava/lang/reflect/Method;"));

    // A inherits from B ==> merge(A[], B[]) = B[]
    assertEquals("[Ljava/lang/reflect/AccessibleObject;", TypeDesc.mergeType("[Ljava/lang/reflect/Method;",
        "[Ljava/lang/reflect/AccessibleObject;"));

    // A inherits from B ==> merge(A[], B[]) = A[]
    assertEquals("[Ljava/lang/reflect/AccessibleObject;", TypeDesc.mergeType("[Ljava/lang/reflect/AccessibleObject;",
        "[Ljava/lang/reflect/Method;"));
