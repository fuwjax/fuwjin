...
import static org.fuwjin.milik.Constants.D_THROWABLE;
  ...
  public void testMethodFrame() {
    ...
    for (BasicBlock bb : flow.getBasicBlocks()) {
      if (bb.startPos == 0) {
        ...
        assertEquals("Lorg/fuwjin/milik/test/ex/ExFrame;", f.getLocal(0).getTypeDesc());
