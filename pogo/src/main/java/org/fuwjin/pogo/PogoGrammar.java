...
public final class PogoGrammar extends Grammar {
   {
      try {
         add(rule("Grammar", "org.fuwjin.pogo.Grammar").add(init("new")).add(result("resolve")).expression(
               seq(ref("Spacing", "default", "default", "default"), plus(ref("Rule", "default", "default", "add")),
         ...
         add(rule("Namespace", "default").expression(
         ...
         add(rule("Expression", "org.fuwjin.pogo.parser.OptionParser").add(init("new")).add(result("reduce"))
               .expression(
                     seq(ref("Sequence", "default", "default", "add"), star(seq(ref("SLASH", "default", "default",
                           "default"), ref("Sequence", "default", "default", "add"))))));
         add(rule("Sequence", "org.fuwjin.pogo.parser.SequenceParser").add(init("new")).add(result("reduce"))
               .expression(plus(ref("Prefix", "default", "default", "add"))));
         ...
         add(rule("Primary", "default").expression(
               option(ref("Reference", "default", "default", "return"), seq(
                     ref("OPEN", "default", "default", "default"), ref("Expression", "default", "default", "return"),
         ...
         add(rule("Reference", "org.fuwjin.pogo.parser.RuleReferenceParser").add(init("new")).expression(
               seq(ref("Identifier", "default", "default", "ruleName"), not(option(lit('<'), lit('='))),
                     optional(seq(ref("HASH", "default", "default", "default"), ref("Function", "default", "default",
                           "constructor"))), optional(seq(ref("OUT", "default", "default", "default"), ref("Function",
                           "default", "default", "matcher"))), optional(seq(ref("COLON", "default", "default",
                           "default"), ref("Function", "default", "default", "converter"))))));
         ...
         add(rule("CharClass", "org.fuwjin.pogo.parser.OptionParser").add(init("new")).add(result("reduce"))
               .expression(
                     seq(lit('['), star(seq(not(lit(']')), option(ref("Range", "default", "default", "add"), ref(
                           "LitChar", "default", "default", "add")))), lit(']'), ref("Spacing", "default", "default",
                           "default"))));
         add(rule("Range", "org.fuwjin.pogo.parser.CharacterRangeParser").add(init("new"))
               .expression(
                     seq(ref("Char", "default", "default", "setStart"), lit('-'), ref("Char", "default", "default",
                           "setEnd"))));
         ...
         add(rule("EscapeChar", "default").expression(
               option(ref("Operator", "default", "return", "default"), ref("ControlChar", "default", "default",
                     "return"), ref("OctalChar", "default", "default", "return"), seq(lit('x'), ref("UnicodeChar",
         ...
         add(rule("AND", "org.fuwjin.pogo.parser.PositiveLookaheadParser").add(init("new")).expression(
               seq(lit('&'), ref("Spacing", "default", "default", "default"), ref("Suffix", "default", "default",
                     "parser"))));
         ...
         add(rule("Spacing", "default").expression(
